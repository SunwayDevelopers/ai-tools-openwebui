...
# Sunway: the four CHANNELS TOOLS were deleted here (hardening plan Item 6) --
# search_channels, search_channel_messages, view_channel_message and view_channel_thread.
# They were MODEL-CALLABLE: a model could search channel names and message bodies and read
# individual messages and threads. All four were read-only and were already gated on
# ENABLE_CHANNELS, so removing them is behaviour-neutral in a deployment with channels off,
# but they were feature surface for a feature that no longer exists.
