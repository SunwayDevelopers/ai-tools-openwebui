...
// Sunway: importConfig and exportConfig were deleted here (hardening plan Item 7). Both of their
// endpoints returned the entire config row unmasked -- every stored credential in one response.
