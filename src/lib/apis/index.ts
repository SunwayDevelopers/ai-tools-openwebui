...
// Sunway: the 8 Pipelines API clients were deleted here (hardening plan Item 2) --
// getPipelinesList, uploadPipeline, downloadPipeline, deletePipeline, getPipelines and the
// three valve helpers. Their endpoints under /api/v1/pipelines no longer exist, and the
// admin/Settings/Pipelines.svelte component that was their only caller is deleted too.
