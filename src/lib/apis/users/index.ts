...
// Sunway: updateUserById was deleted here (hardening plan Item 5). Its endpoint,
// POST /api/v1/users/{user_id}/update, no longer exists -- every field on that form was owned
// by IAM, so the edits never actually held. See routers/users.py.
