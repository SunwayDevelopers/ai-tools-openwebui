		...
		<div class="m-auto pb-10 flex flex-col justify-center">
			<div class="max-w-md">
				...
				<div class=" mt-6 mx-auto relative group w-fit">
					<button
						class="relative z-20 flex px-5 py-2 rounded-full bg-white border border-gray-100 dark:border-none brand-nav-item text-gray-700 transition font-medium text-sm"
						on:click={async () => {
							location.href = '/';
						}}
					>
