		...
		{#if collapsible}
			...
			>
				...
				<div
					...
					class=" w-full group rounded-xl relative flex items-center justify-between brand-nav-item transition {buttonClassName}"
				>
					...
					{#if onAdd}
						...
						>
							<Tooltip content={onAddLabel}>
								<button class="p-0.5 brand-nav-item rounded-lg touch-auto" on:click={(e) => {}}>
