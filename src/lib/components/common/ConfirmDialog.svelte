		...
		>
			<div class="px-[1.75rem] py-6 flex flex-col">
				...
				<div class="mt-6 flex justify-between gap-1.5">
					<button
						class="text-sm bg-gray-100 brand-nav-item text-gray-800 dark:bg-gray-850 brand-nav-item dark:text-white font-medium w-full py-2 rounded-3xl transition"
						on:click={() => {
							show = false;
							dispatch('cancel');
						}}
					...
					<button
						class="text-sm bg-gray-900 brand-nav-item text-gray-100 dark:bg-gray-100 brand-nav-item dark:text-gray-800 font-medium w-full py-2 rounded-3xl transition"
						on:click={() => {
							confirmHandler();
						}}
						type="button"
