				...
				>
					...
					<div class="flex justify-between items-center gap-2 mt-2">
						<div class="shrink-0">
							...
							<button
								type="button"
								class="px-3.5 py-1.5 text-sm font-medium bg-gray-50 brand-nav-item text-gray-900 dark:bg-gray-850 brand-nav-item dark:text-gray-200 transition rounded-lg"
						...
						<div class="flex gap-2 shrink-0">
							{#if !loading}
								<button
									...
									class="px-3.5 py-1.5 text-sm font-medium brand-btn-primary brand-nav-item transition rounded-lg disabled:opacity-50 disabled:cursor-not-allowed"
