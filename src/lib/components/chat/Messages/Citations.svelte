...
{#if citations.length > 0}
	...
	<div class=" py-1 -mx-0.5 w-full flex gap-1 items-center flex-wrap">
		<button
			class="text-xs font-medium text-gray-600 dark:text-gray-300 px-3.5 h-8 rounded-full brand-nav-item transition flex items-center gap-1 border border-gray-50 dark:border-gray-850/30"
